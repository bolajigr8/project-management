...
export function Sidebar() {
  ...
  return (
    <div className={sidebarClassNames}>
      <main className="flex h-[100%] w-full flex-col justify-start">
        {/* Top Logo */}

        <section className="z-50 flex min-h-[56px] w-64 items-center justify-between bg-white px-6 pt-3 dark:bg-black">
        ...
        <section className="flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700">
          ...
          />
          <div>
            <h3 className="text-md font-extrabold tracking-wide text-black dark:text-gray-200">
              MICBOL TEAM
            </h3>
